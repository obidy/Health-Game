...
struct DetailedforaridebookingOneView: View {
    @StateObject var detailedforaridebookingOneViewModel = DetailedforaridebookingOneViewModel()
            ...
            VStack {
                    ...
                    VStack {
                        VStack(alignment: .leading, spacing: 0) {
                            Image("img_arrowleft")
                                ...
                                .onTapGesture {
                                    detailedforaridebookingOneViewModel.nextScreen = "HomepageView"
                                }
                            Text(StringConstants.kLblDelivery)
                                ...
                                .onTapGesture {
                                    detailedforaridebookingOneViewModel.nextScreen = "MenupageView"
                                }
                            Text(StringConstants.kMsgForgotToLeave)
                            ...
                            ZStack(alignment: .topTrailing) {
                                ...
                                Image("img_wavybuddies")
                                    ...
                                    .scaledToFit()
                                    .clipped()
                                    .padding(.top, getRelativeHeight(74.21))
                                    .padding(.trailing, getRelativeWidth(98.0))
                            }
                            .hideNavigationBar()
                            .frame(width: getRelativeWidth(272.0), height: getRelativeHeight(183.0),
                                   alignment: .trailing)
                ...
                Group {
                    NavigationLink(destination: HomepageView(),
                                   tag: "HomepageView",
                                   selection: $detailedforaridebookingOneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct DetailedforaridebookingOneView_Previews: PreviewProvider {
    static var previews: some View {
        DetailedforaridebookingOneView()
    }
}
