...
struct DetailedforaridebookingThreeView: View {
    @StateObject var detailedforaridebookingThreeViewModel = DetailedforaridebookingThreeViewModel()
            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    VStack(alignment: .leading, spacing: 0) {
                        Image("img_arrowleft")
                            ...
                            .onTapGesture {
                                detailedforaridebookingThreeViewModel.nextScreen = "HomepageView"
                            }
                        Text(StringConstants.kMsgWaitMorePay)
                            .font(FontScheme.kPoppinsSemiBold(size: getRelativeHeight(24.0)))
                            .fontWeight(.semibold)
                            .foregroundColor(ColorConstants.WhiteA700)
                            .minimumScaleFactor(0.5)
                            .multilineTextAlignment(.leading)
                            .frame(width: getRelativeWidth(240.0), height: getRelativeHeight(36.0),
                                   alignment: .topLeading)
                            .padding(.top, getRelativeHeight(27.0))
                            .padding(.trailing, getRelativeWidth(10.0))
                            .onTapGesture {
                                detailedforaridebookingThreeViewModel.nextScreen = "MenupageView"
                            }
                        Text(StringConstants.kMsgNotHurryingW)
                            .font(FontScheme.kPoppinsMedium(size: getRelativeHeight(15.0)))
                            .fontWeight(.medium)
                            .foregroundColor(ColorConstants.WhiteA700)
                            .minimumScaleFactor(0.5)
                            .multilineTextAlignment(.leading)
                            .frame(width: getRelativeWidth(263.0), height: getRelativeHeight(78.0),
                                   alignment: .topLeading)
                        ...
                        ZStack(alignment: .topTrailing) {
                            ...
                            Image("img_palzdelivery")
                                ...
                                .scaledToFit()
                                .clipped()
                                .padding(.top, getRelativeHeight(103.21))
                                .padding(.trailing, getRelativeWidth(160.18))
                        }
                        .hideNavigationBar()
                ...
                Group {
                    NavigationLink(destination: MenupageView(),
                                   tag: "MenupageView",
                                   selection: $detailedforaridebookingThreeViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct DetailedforaridebookingThreeView_Previews: PreviewProvider {
    static var previews: some View {
        DetailedforaridebookingThreeView()
    }
}
