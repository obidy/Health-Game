...
struct DetailedforaridebookingSevenView: View {
    @StateObject var detailedforaridebookingSevenViewModel = DetailedforaridebookingSevenViewModel()
            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    VStack(alignment: .leading, spacing: 0) {
                        Image("img_arrowleft")
                            ...
                            .onTapGesture {
                                detailedforaridebookingSevenViewModel.nextScreen = "HomepageView"
                            }
                        Text(StringConstants.kLblPetFriendly)
                            .font(FontScheme.kPoppinsSemiBold(size: getRelativeHeight(24.0)))
                            .fontWeight(.semibold)
                            .foregroundColor(ColorConstants.WhiteA700)
                            .minimumScaleFactor(0.5)
                            .multilineTextAlignment(.leading)
                            .frame(width: getRelativeWidth(138.0), height: getRelativeHeight(36.0),
                                   alignment: .topLeading)
                            .padding(.top, getRelativeHeight(27.0))
                            .padding(.trailing, getRelativeWidth(10.0))
                            .onTapGesture {
                                detailedforaridebookingSevenViewModel.nextScreen = "MenupageView"
                            }
                        Text(StringConstants.kMsgWeIncludePet)
                            .font(FontScheme.kPoppinsMedium(size: getRelativeHeight(15.0)))
                            .fontWeight(.medium)
                            .foregroundColor(ColorConstants.WhiteA700)
                            .minimumScaleFactor(0.5)
                            .multilineTextAlignment(.leading)
                            .frame(width: getRelativeWidth(227.0), height: getRelativeHeight(60.0),
                                   alignment: .topLeading)
                ...
                Group {
                    NavigationLink(destination: MenupageView(),
                                   tag: "MenupageView",
                                   selection: $detailedforaridebookingSevenViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct DetailedforaridebookingSevenView_Previews: PreviewProvider {
    static var previews: some View {
        DetailedforaridebookingSevenView()
    }
}
