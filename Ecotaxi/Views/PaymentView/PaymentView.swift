            ...
            VStack {
                VStack {
                    VStack(alignment: .leading, spacing: 0) {
                        Image("img_arrowleft")
                            ...
                            .padding(.trailing)
                            .onTapGesture {
                                paymentViewModel.nextScreen = "MenupageView"
                            }
                    ...
                    VStack {
                        VStack(alignment: .leading, spacing: 0) {
                            ...
                            Divider()
                                ...
                                .padding(.horizontal, getRelativeWidth(13.0))
                            Text(StringConstants.kMsgEcotaxiBalance)
                        ...
                        .onTapGesture {
                            paymentViewModel.nextScreen = "PromotionView"
                        }
                    ...
                    VStack {
                        ...
                        VStack(alignment: .leading, spacing: 0) {
                            ...
                            .frame(width: getRelativeWidth(287.0), height: getRelativeHeight(27.0),
                                   alignment: .leading)
                            .padding(.top, getRelativeHeight(25.0))
                        }
                        .frame(width: getRelativeWidth(287.0), height: getRelativeHeight(77.0),
                               alignment: .center)
                        .padding(.top, getRelativeHeight(41.0))
                        .padding(.leading, getRelativeWidth(17.0))
                    ...
                    .frame(width: getRelativeWidth(317.0), height: getRelativeHeight(141.0),
                           alignment: .center)
                    .padding(.top, getRelativeHeight(23.0))
                    .padding(.horizontal, getRelativeWidth(25.0))
                    VStack(alignment: .leading, spacing: 0) {
                        HStack {
                            ...
                            Text(StringConstants.kMsgAddDebitCredi)
                                ...
                                .padding(.leading, getRelativeWidth(20.0))
                                .onTapGesture {
                                    paymentViewModel.nextScreen = "PaymentOneView"
                                }
                        }
                        ...
                        HStack {
                            HStack {
                                ...
                                Text(StringConstants.kMsgSetUpWorkPro)
                                    ...
                                    .onTapGesture {
                                        paymentViewModel.nextScreen = "WorkTripView"
                                    }
                            }
                    ...
                    .frame(width: getRelativeWidth(317.0), height: getRelativeHeight(44.0),
                           alignment: .center)
                ...
                Group {
                    NavigationLink(destination: PromotionView(),
                                   tag: "PromotionView",
                                   selection: $paymentViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                    NavigationLink(destination: PaymentOneView(),
                                   tag: "PaymentOneView",
                                   selection: $paymentViewModel.nextScreen,
                                   label: {
                                       EmptyView()
